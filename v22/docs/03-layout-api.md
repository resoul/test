...
Не сделано: фокус на tvOS не уходит к нодам за краем окна — движок фокуса tvOS ищет только в
видимой области, а внутри прокрутки нужен `UIFocusItemScrollableContainer` (следующий
срез, проверка — UI-тест с пультом); отскок на Mac; прокрутка VoiceOver тремя пальцами
