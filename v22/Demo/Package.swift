...
// A screen built from nodes — text, appearance, state, taps, a breakpoint and scrolling —
// and a Mac window showing it: `swift run` in this folder. The iOS app in
// `../DemoiOS.swiftpm` shows the same screen (`DemoScreens`), and so does the Apple TV app
// in `../DemotvOS`.
let package = Package(
    name: "LayoutDemo",
