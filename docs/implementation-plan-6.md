...
R10–R11, R12a–R12c, R13 закрыты; R12 (закрытие C) закрыта частично (нет числовых бюджетов на устройстве); R14 в работе (этап 1 собирается, host-тесты зелёные); R15 не выполнена. Подключение собственной библиотеки Flux и создание
...
пользователя собирается без предупреждений, host-тесты R14 и тесты R13 зелёные:
