...
R10–R11, R12a–R12c, R13 закрыты; R12 (закрытие C) закрыта частично (нет числовых бюджетов на устройстве); R14 в работе (этап 1 собирается, тесты проверены частично); R15 не выполнена. Подключение собственной библиотеки Flux и создание
...
**В работе, 2026-09-23.** Этап 1 написан в облачной сессии без Swift/Xcode; на Mac
пользователя собирается без предупреждений, host-тесты проверены частично:
