...
R10–R11, R12a–R12c, R13 закрыты; R12 (закрытие C) закрыта частично (нет числовых бюджетов на устройстве); R14–R15 не выполнены. Подключение собственной библиотеки Flux и создание
...
нужно уточнить при обсуждении paging.
...
Разворачивание шапки не стирает глубокую позицию неактивной страницы; правило
её восстановления и нормализации проверяется на двух длинных и одной короткой
странице. При горизонтальном drag вертикальное владение фиксируется по правилам
...
- [ ] Реализовать TabbedScrollNode/Tab/TabsNode по P6.5, оба режима .pinned/.inline;
  ...
  P6.6, смену контекста и альтернативный доступ к действиям.
...
- [ ] Подтвердить композицию §1.1: произвольный Node с детьми сверху, pager ниже,
  ...
  Уточнить оставшиеся пороги/физику paging и проверить согласованную P6.5 композицию.

- [ ] P6.5, pinned tabs, независимые позиции страниц, короткий контент,
