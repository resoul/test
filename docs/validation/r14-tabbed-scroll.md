...
Статус на 2026-09-23: **этап 1 собирается, host-тесты R14 и тесты R13 зелёные; остальные проверки не выполнены.** Код написан
...
Выполнены пункт 1 и отфильтрованные прогоны пункта 2 (см. статус выше); полный `swift test` и остальное не запускалось.
